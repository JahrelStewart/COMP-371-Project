...
int main()
{
    ...
    glm::vec3 wallPositions[] = {
        ...
        glm::vec3(-0.75f,  -0.50f,  0.0f),
        glm::vec3(-0.50f,  -0.50f,  0.0f),
        glm::vec3(-0.25f,  -0.50f,  0.0f),
        ...
        glm::vec3(-0.50f,  -0.25f,  0.0f),
       // glm::vec3(-0.25f,  -0.25f,  0.0f), //hole
        ...
        //glm::vec3(-0.25f,  0.0f,  0.0f), //hole
       // glm::vec3(0.0f,  0.0f,  0.0f), //hole 
      //  glm::vec3(0.25f,  0.0f,  0.0f), //hole
        glm::vec3(0.50f,  0.0f,  0.0f),
        glm::vec3(0.75f,  0.0f,  0.0f),
        ...
        glm::vec3(0.0f,  0.25f,  0.0f),
        //glm::vec3(0.25f,  0.25f,  0.0f), // hole
        //glm::vec3(0.50f,  0.25f,  0.0f), //hole
        glm::vec3(0.75f,  0.25f,  0.0f),
        glm::vec3(1.0f,  0.25f,  0.0f),
...
// --------------------
        ...
        // render boxes
        ourShader.setVec3("ourColor", glm::vec3(0.3f, 0.0f, 0.4f));
        glBindVertexArray(VAO);
        for (unsigned int i = 0; i < 9; i++)
        {
            ...
            model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f)); // scale cubes
        ...
        //render wall
         ourShader.setVec3("ourColor", glm::vec3(0.1f, 0.0f, 0.4f));
        //hole
        for (unsigned int i = 0; i < 6; i++)
        {
            glm::mat4 model = glm::mat4(1.0f);
            model = glm::translate(model, holePositions[i]);
            model = glm::translate(model, glm::vec3(0.0f, 0.0f, -0.75f));
            model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.2 * 0.25f)); 
            ourShader.setMat4("model", model);
