...
int main(int argc, char* argv[])
{
    ...
    GLuint decidedLocation = glGetUniformLocation(shaderProgram, "decided_color");
    ...
    while (!glfwWindowShouldClose(window))
    {
      ...
      //  mat4 pillarWorldMatrix = translate(mat4(1.0f), vec3(0.0f, 10.0f, 0.0f)) * scale(mat4(1.0f), vec3(1.0f, 1.0f, 1.0f));
        ...
        if (glfwGetKey(window, GLFW_KEY_U) == GLFW_PRESS) {
            ...
            cube = translate(mat4(1.0f), vec3(0.0f, 0.0f, 0.0f))*scale(mat4(1.0f), vec3(2.0f, 2.0f, 2.0f)); //* scale(mat4(1.0f), vec3(1.0f, 1.0f, 2.0f));
            glUniformMatrix4fv(worldMatrixLocation, 1, GL_FALSE, &cube[0][0]);
            glDrawArrays(GL_TRIANGLES, 0, 36);
            ...
            cube = translate(mat4(1.0f), vec3(0.0f, 0.0f, 0.0f)); //* scale(mat4(1.0f), vec3(1.0f, 1.0f, 2.0f));
            glUniformMatrix4fv(worldMatrixLocation, 1, GL_FALSE, &cube[0][0]);
            glDrawArrays(GL_TRIANGLES, 0, 36);
      ...
      /*
       if (glfwGetKey(window, GLFW_KEY_U) == GLFW_PRESS) {
           ...
           cube = translate(mat4(1.0f), vec3(0.0f, 1.0f, 0.0f)) * scale(mat4(1.0f), vec3(2.0f, 2.0f, 2.0f)); //* scale(mat4(1.0f), vec3(1.0f, 1.0f, 2.0f));
           glUniformMatrix4fv(worldMatrixLocation, 1, GL_FALSE, &cube[0][0]);
           glDrawArrays(GL_TRIANGLES, 0, 36);
       ...
       */
       ...
       if (glfwGetKey(window, GLFW_KEY_U) == GLFW_PRESS) {
           ...
           cube = translate(mat4(1.0f), vec3(0.0f, 2.0f, 0.0f)) * scale(mat4(1.0f), vec3(2.0f, 2.0f, 2.0f)); //* scale(mat4(1.0f), vec3(1.0f, 1.0f, 2.0f));
           glUniformMatrix4fv(worldMatrixLocation, 1, GL_FALSE, &cube[0][0]);
           glDrawArrays(GL_TRIANGLES, 0, 36);
